...
import IncrementPdf from './SurrenderPdf'; // Ensure this matches the new filename
import './increment.css';
import dayjs from 'dayjs';

const { Title } = Typography;

const SurrenderLeave = () => {
    ...
    const handleIncrementSubmit = async (values) => {
        ...
        try {
            await axios.post('https://hsbackendpkm.vercel.app/surrender', employeeData);
    ...
    return (
        <div className="p-6 bg-base-200 min-h-screen">
            <div className="max-w-4xl mx-auto bg-base-100 p-6 rounded-box shadow">
                <Title level={2} className="form-header">Sanction Surrender Leave</Title>
                        ...
                        <Card key={index} title={`Employee ${index + 1}`} bordered={true} className="form-card">
                            <div className="bg-base-200 p-4 rounded-md">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <Form.Item
                                        label="Basic Pay"
                                        rules={[{ required: true, message: 'Please enter the Basic Pay!' }]}
                                    >
                                        <Input
                                    ...
                                    <Form.Item
                                        label="Available E.L."
                                        rules={[{ required: true, message: 'Please enter Available E.L.!' }]}
                                    >
                                        <Input
                                            placeholder="Enter Available E.L."
                                            type="number"
                                            min={0}
                                    ...
                                    <Form.Item
                                        label="Surrendered Leave Days"
                                        rules={[{ required: true, message: 'Please enter Surrendered Leave Days!' }]}
                                    >
                                        <Input
                                            placeholder="Enter Surrendered Leave Days"
                                            type="number"
                                            min={0}
                                    ...
                                    <Form.Item label="Leave Start Date">
                                        <DatePicker
                                            format="DD-MM-YYYY"
                                    ...
                                    <Form.Item label="Leave End Date">
                                        <DatePicker
                                            format="DD-MM-YYYY"
