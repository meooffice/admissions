...
import './SearchAndUpdateForm.css'; // Import custom CSS for styling
...
const SearchAndUpdateForm = () => {
    ...
    const [admNo, setAdmNo] = useState(''); // State for admission number
    const [record, setRecord] = useState(null); // State for fetched record
    const [loading, setLoading] = useState(false); // State to handle button loading and label
    ...
    return (
        <div className="p-6 bg-base-200 min-h-screen">
            <div className="max-w-4xl mx-auto bg-base-100 p-6 rounded-box shadow">
                <h2 className="text-3xl font-bold text-primary mb-6 text-center">Search & Edit Student Records
                ...
                <div className="flex justify-center gap-4 items-center mb-6">
                    ...
                    />
                    <button onClick={handleSearch} className="btn btn-outline border-2 btn-success w-32 font-bold text-success hover:text-gray-600 ">Fetch Record</button>
                </div>
                    ...
                    >
                        ...
                        <Form.Item>
                            <div className="flex justify-center">
                                <button
                                    type="submit"
                                    className={`btn btn-outline border-2 btn-success w-32 font-bold text-success hover:text-gray-600 ${loading ? 'btn-disabled' : 'btn-primary'}`}
                                    disabled={loading}
                                >
