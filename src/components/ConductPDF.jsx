        ...
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.section}>
                    <Text style={styles.legendLabel}>CONDUCT CERTIFICATE</Text>
                ...
                <Text style={styles.declaration}>
                    ...
                    And {' '}{record.gender === 'Boy' ? 'His' : 'Her'} {' '} Conduct is: <Text style={styles.underline}>___________</Text>.
                </Text>
